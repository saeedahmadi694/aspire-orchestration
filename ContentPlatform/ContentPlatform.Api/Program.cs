...
builder.Services.AddMassTransit(busConfigurator =>
{
    ...
    busConfigurator.AddRequestClient<ArticleCreatedEvent>();
    busConfigurator.AddRequestClient<ArticleDeletedEvent>();
    busConfigurator.AddRequestClient<ArticleViewedEvent>();
